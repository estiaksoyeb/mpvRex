...
> [!NOTE]
> **Repository Notice**: The project has officially moved from `sfsakhawat999/mpvRex` to [mpvRex/REX-Player](https://github.com/mpvRex/REX-Player). Please make sure to update your git remotes and bookmarks!
